<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Dapp2018_00.Aspx.Index" %>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
 ...
 <link href="../Content/css/Index/animate.css" rel="stylesheet" />
<link href="../Content/css/Index/bootstrap.css" rel="stylesheet" />
<link href="../Content/css/Index/icomoon.css" rel="stylesheet" />
  <!--
    <link rel="stylesheet" href="css/animate.css">
	<link rel="stylesheet" href="css/bootstrap.css">
	<link rel="stylesheet" href="css/icomoon.css"> -->

<link href="../Content/css/Index/owl.carousel.min.css" rel="stylesheet" />
<link href="../Content/css/Index/owl.theme.default.min.css" rel="stylesheet" />
...
<link href="../Content/css/Index/style.css" rel="stylesheet" />
<script src="../Content/css/Index/modernizr-2.6.2.min.js"></script>
							...
							<div class="drop-down-menu">
								...
								<div class="dropdown-menu-wrap">
									<ul>
										...
										<li><a href="RegistrAlumn.aspx">Regitrarme</a></li>
		...
		<div class="fh5co-slider">
			<div class="container">
				<div class="owl-carousel owl-carousel-main">
				  <div><img src="../Imagenes/s1.jpg" alt="Nuse xD"></div>
				  <div> <img src="../Imagenes/s2.jpg" /></div>
				  <div> <img src="../Imagenes/s3.jpg" /></div>
				</div>
			</div>
		</div>
		<!-- Slider -->
			...
			<div class="container">
				<div class="row row-bottom-padded-md">
					<div class="col-md-8 col-md-offset-2 text-center ts-intro">
						<h1>Mi First Game - Aplicación Educativa</h1>
                        <p class="MsoNormal">
                            <span lang="ES-PE">Permiten&nbsp;<span>estudiar en cualquier momento el lugar</span>, anulando el problema de las distancias geográficas o temporales y ofreciendo una gran libertad en cuanto a tiempo y ritmo de aprendizaje.<o:p></o:p></span></p>
                        <p>
                            &nbsp;</p>
					</div>
				</div>
...
<script src="../Content/css/Index/jquery.min.js"></script>
<script src="../Content/css/Index/jquery.easing.1.3.js"></script>
<script src="../Content/css/Index/bootstrap.min.js"></script>
<script src="../Content/css/Index/owl.carousel.min.js"></script>
<script src="../Content/css/Index/main.js"></script>
