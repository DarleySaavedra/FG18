<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrAlumn.aspx.cs" Inherits="Dapp2018_00.Aspx.RegistrAlumn" %>
    ...
    <div class="container well contenedor" style="margin-top:-75px">
       ...
       <div class="form-group " >
         ...
         <div class="form-group" style="margin-top:5px">
          ...
          <div class="form-group">
           <asp:button runat="server" text="REGISTRAR" CssClass="form-control btn btn-primary" ID="bregistrar" OnClick="bregistrar_Click"  />
              </div>
  </form>
