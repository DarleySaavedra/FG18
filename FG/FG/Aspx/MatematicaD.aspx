<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MatematicaD.aspx.cs" Inherits="FG.Aspx.MatematicaD" %>
      ...
      <div class="navbar-nav navbar-sidenav" id="exampleAccordion">
         <div class="pull-left image">
            ...
            <div class="pull-left info">
              <p style="color:white; margin-left:30px">Nombre:&nbsp; <asp:Label ID="nombredc" runat="server" Text="" style="color:white"></asp:Label></p>
